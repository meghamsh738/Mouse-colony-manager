export const SEED_REFERENCE_DATE = "2026-04-05T09:00:00.000Z";
export const SEEDED_DEV_PASSWORD = "colony123";

export const SEEDED_DEV_EMAILS = {
  admin: "admin@colony.local",
  manager: "manager@colony.local",
  staff: "staff@colony.local",
