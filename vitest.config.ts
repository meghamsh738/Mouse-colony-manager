    ...
    projects: [
      {
        ...
        test: {
          ...
          include: [
            ...
            "tests/unit/reconciliation-command.integration.test.ts",
            "tests/unit/reconciliation-safety.integration.test.ts",
            "tests/unit/reconciliation-migration-atomicity.integration.test.ts",
